...
public class ReportController {
    ...
    public @ResponseBody ResponseEntity<List<ReportAllProductResponse>> allProductList(@RequestBody ReportRequest request) {
    ...
    @GetMapping("/remnants")
    public @ResponseBody ResponseEntity<List<ReportRemnantsResponse>> remnants(@RequestBody ReportRequest request) {
